<script setup="">
  ...
  import {friends_info} from "../../../mock/json/listdata.json"
  ...
  onMounted(() => {
    router.push(friends_info[0].url)
  })
</script>
<template>
    ...
    <div class="info">
      ...
      <div class="info-menu">
        <el-menu default-active="1" class="el-menu-vertical-demo" style="margin-top: 40px">
          <el-menu-item v-for="(item,index) in friends_info" :index="item.id" @click="showView(item.url)">
            <template #title>
              <el-icon>
