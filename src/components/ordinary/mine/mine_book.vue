<script setup="">
  ...
  import {books_info} from "../../../mock/json/listdata.json"
    ...
    <div class="info">
      ...
      <div class="info-menu">
        <el-menu default-active="1" class="el-menu-vertical-demo" style="margin-top: 40px">
          <el-menu-item v-for="(item,index) in books_info" :index="item.id" @click="showView(item.url)">
            <template #title>
              <el-icon>
